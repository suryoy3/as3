...
public class Dealer extends Player {
 ...
 showHand();  // Reveal the dealer's hidden card

    while (hitRule.doHit(this)) { // While dealer should continue hitting based on the rules
        hit(this);  // Dealer takes a card
    }
    return false;  // Indicate that the dealer's turn is over
  }
}